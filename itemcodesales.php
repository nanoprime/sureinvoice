...
<table border="0" cellspacing="0" cellpadding="0" class="dg_table">
	<tr>
		...
		<th class="dg_header_cell"><a class="link1" href="" onclick="return sortTable('bodyId1', 1, 0, false)">Description</a></th>
...
<?	$i = 0;
	...
	<tr onmouseover="this.style.backgroundColor ='#CCCCCC'" onmouseout="this.style.backgroundColor ='#FFFFFF'">
		...
		<td class="dg_data_cell_1"><?= $row['description'] ?></td>
		<td class="dg_data_cell_1" align="right"><a href="itemcodesalesdetail.php?start_ts=<?= $start_ts ?>&end_ts=<?= $end_ts ?>&item_code_id=<?= $row['item_code_id'] ?>"><?= SureInvoice::getCurrencySymbol().number_format($row['sales'], 2) ?></a></td>
	</tr>
<?	}?>
	</tbody>
	<tr>
