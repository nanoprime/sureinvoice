...
<tr>
	<td>
		<p>Press the Run button below to begin the import. This could take a while depending on how big the import is.</p>
	</td>
</tr>
<tr><td>
<? if(isset($_POST['run'])){ ?>
...
<tr>
  <td>
  	...
  	<input type="submit" name="run" class="button" value="Run" />
  </td>
</tr>
</table>
</form>
